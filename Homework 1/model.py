# Source : https://github.com/shankarpandala/lazypredict/blob/dev/lazypredict/Supervised.py
# This is a modified version of the original LazyPredict/Supervised.py file.
...
REGRESSORS = [(m.__class__.__name__, m) for m in REGRESSORS]
...
CLASSIFIERS = [(m.__class__.__name__, m) for m in CLASSIFIERS]
